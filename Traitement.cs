     ...
     static class Traitement
    {
        ...
        public static void TesteDOssier()
        {
            try
            {
                ...
                Prestations p3 = new Prestations("P3", Convert.ToDateTime("10/09/2015 12:00:00"), DP);
                ...
                Dossier dossier = new Dossier("Robert", "Jean", Convert.ToDateTime("03/12/1980"), prestations);
            ...
            catch (Soins2021.SoinsException ex)
            {
